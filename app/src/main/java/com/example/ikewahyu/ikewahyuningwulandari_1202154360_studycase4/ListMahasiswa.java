package com.example.ikewahyu.ikewahyuningwulandari_1202154360_studycase4;
...
public class ListMahasiswa extends AppCompatActivity implements View.OnClickListener {
    ...
    private String[] namaMahasiswa = {"Ike", "Wahyu", "Wulan", "Dari", "Keke", "Emi", "Diah",
            "Citra", "Bulan", "Sinta", "Iti", "Gabby", "Deva", "Tata", "Dede", "Baba", "Lala", "Kasih"};
